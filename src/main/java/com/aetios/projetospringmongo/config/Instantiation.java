...
public class Instantiation implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Post post1 = new Post(null, sdf.parse("08/03/2023"), "Titulo 1", "Texto a ser inserido.", user1);
        Post post2 = new Post(null, sdf.parse("08/03/2023"), "Titulo 2", "Texto a ser inserido.", user1);
        Post post3 = new Post(null, sdf.parse("10/03/2023"), "Titulo 3", "Texto a ser inserido.", user2);
